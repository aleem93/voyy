...
(function($) {
  ...
  $('.first.circle').circleProgress({
   ...
   $('.second.circle').circleProgress({
    value: 0,
    animation: true,
    fill: {gradient: ['#52A9C5', '#52A9C5']}
  });
   $('.three.circle').circleProgress({
    value: 0,
    animation: true,
    fill: {gradient: ['#339D92', '#339D92']}
  });
   $('.four.circle').circleProgress({
    value: 0,
    animation: true,
    fill: {gradient: ['#A979A9', '#A979A9']}
  });
  $('.five.circle').circleProgress({
    value: 1,
    animation: true,
    fill: {gradient: ['#5cb85c', '#5cb85c']}
  });
  var getvalsix = $("#sixcirclevalue").val();
   $('.six.circle').circleProgress({
    value: getvalsix,
    animation: true,
    fill: {gradient: ['#ff1e41', '#ff5f43']}
  });
  var getvalseven = $("#sevencirclevalue").val();
   $('.seven.circle').circleProgress({
    value: getvalseven,
    animation: true,
    fill: {gradient: ['#52A9C5', '#52A9C5']}
  });
  var getvaleight = $("#eightcirclevalue").val();
   $('.eight.circle').circleProgress({
    value: getvaleight,
    animation: true,
    fill: {gradient: ['#339D92', '#339D92']}
  });
  var getvalnine = $("#ninecirclevalue").val();
